...
def loop_query(query_index):
    ...
    NDCG_file_name = NDCGdata_path + '{}_validity_complement'.format(dataname) + modelname + '.txt'
    ranklist_file = NDCGdata_path + '{}_ranklist_validity_complement'.format(dataname) + modelname + '.txt'
...
if __name__ == '__main__':
    ...
    # model_set  =['Linearregression_model.txt','coordinateascent_model.txt','Randomforest_model.txt','Listnet_model.txt','LambdaMART_model.txt','Ranknet_model.txt']
    ...
    for MODEL in model_set:
        ...
        for f in range(1, 2):
            ...
            resultfile_NDCG = 'resultfile/' + '{}_{}_validitycomplement_NDCG.txt'.format(dataname, modelname)
            resultfile_tau = 'resultfile/' + '{}_{}_validitycomplement_tau.txt'.format(dataname, modelname)
            resultfile_ratio = 'resultfile/' + '{}_{}_validitycomplement_ratio.txt'.format(dataname, modelname)

            old_NDCG_file = NDCGdata_path + 'MQ2008_1_validity_10features{}.txt'.format(modelname)
            feature_set = []
