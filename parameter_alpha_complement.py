...
def loop_query(query_index):
    ...
    NDCG_file_name = NDCGdata_path + '{}_alpha{}_complement'.format(dataname, alpha) + modelname + '.txt'
    ranklist_file = NDCGdata_path + '{}_ranklist_alpha{}_complement'.format(dataname, alpha) + modelname + '.txt'
...
if __name__ == '__main__':
    ...
    #model_set = ['Linearregression_model.txt','LambdaMART_model.txt','coordinateascent_model.txt','Ranknet_model.txt','Listnet_model.txt']
    for MODEL in model_set:
        ...
        for alpha in np.arange(0.1,1.0,0.2):
            ...
            # the path of data
                ...
                temp_path = 'temp_data_validity_complement/'
                ...
                resultfile_NDCG = 'resultfile/' + '{}_{}_alphacomplement_NDCG.txt'.format(dataname,modelname)
                resultfile_tau = 'resultfile/' + '{}_{}_alphacomplement_tau.txt'.format(dataname,modelname)
                resultfile_ratio =  'resultfile/' + '{}_{}_alphacomplement_ratio.txt'.format(dataname,modelname)

                old_NDCG_file = NDCGdata_path+ 'MQ2008_1_alpha{}_10features{}.txt'.format(alpha,modelname)
                feature_set = []
