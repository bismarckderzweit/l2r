...
def score(X):
    ...
    """
    A = []
    scorefile_path = temp_path + 'scorefile_validity_{}.txt'.forfmat(tmp_test_y_query[0].split(':')[-1].split()[0])
...
if __name__ == '__main__':
    ...
    # model_set = ['LinearRegression_model.txt','LambdaMART_model.txt','coordinateascent_model.txt','Randomforests_model.txt','Listnet_model.txt']
    for MODEL in model_set:
        ...
        for f in range(1, 2):
            ...
            old_NDCG_file = NDCGdata_path + 'MSLR-WEB10K_1_validity_10features{}.txt'.format(modelname)
            feature_set = []
