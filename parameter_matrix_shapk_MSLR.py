...
def loop_query(query_index):
    ...
    def feature_k_loop(feature_number, threshold_flag):
        ...
        NDCG_file_name = NDCGdata_path + '{}_SHAP{}_{}features_threshold{}'.format(dataname, k, feature_number,
                                                                                   threshold_flag) + modelname + '.txt'
        ranklist_file = NDCGdata_path + '{}_ranklist_SHAP{}_{}features_threshold{}'.format(dataname, k, feature_number,
                                                                                           threshold_flag) + modelname + '.txt'
...
if __name__ == '__main__':
    ...
    for MODEL in model_set:
        ...
        for f in range(1, 2):
            ...
            temp_path = 'temp_data_shapk_MSLR/'
            ...
            for k in k_set:
                ...
                for threshold_flag in threshold:
                    for feature_number in (5, 10):
                        NDCG_file_name = NDCGdata_path + '{}_SHAP{}_{}features_threshold{}'.format(dataname, k,
                                                                                                   feature_number,
                                                                                                   threshold_flag) + modelname + '.txt'
                        ranklist_file = NDCGdata_path + '{}_ranklist_SHAP{}_{}features_threshold{}'.format(dataname, k,
                                                                                                           feature_number,
                                                                                                           threshold_flag) + modelname + '.txt'
