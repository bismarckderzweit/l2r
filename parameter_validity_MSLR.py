...
def score(X):
    """
    First calling the subprocess of ranklib
...
def loop_query(query_index):
    ...
    # get the score matrix, please distinguish it with the feature matrix, there are 2 matrixes here
    ...
    def feature_k_loop(feature_number):
        ...
        restore_path = temp_path + 'restore_validity_{}.txt'.format(query_id, feature_number)
        scorefile_path = temp_path + 'scorefile_validity_{}.txt'.format(query_id, feature_number)
...
if __name__ == '__main__':
    ...
    for MODEL in model_set:
        ...
        for f in range(1, 2):
            ...
            temp_path = 'temp_data_validity_MSLR/'
